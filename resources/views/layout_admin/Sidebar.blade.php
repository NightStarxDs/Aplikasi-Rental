<nav class="fixed top-0 z-50 w-full border-b bg-green-950 border-default">
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 7h14M5 12h14M5 17h10"/>
      ...
      <div class="flex items-center">
          <div class="flex items-center ms-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-950" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                <span class="sr-only">Open user menu</span>
                <img class="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
              </button>
            </div>
            <div class="z-30 hidden bg-neutral-primary-medium border border-default-medium rounded-lg shadow-lg w-44" id="dropdown-user">
              ...
              <ul class="p-2 text-sm text-body font-medium" role="none">
                <li>
                  ...
                  <a href="{{ route('profile.edit') }}" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded" role="menuitem">
                            {{ __('Profile') }}
                  </a>
                </li>
                <li>
                  <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="route('logout')" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded" role="menuitem"
...
<aside id="top-bar-sidebar" class="fixed top-0 left-0 z-40 z-index-1 w-64 h-full bg-neutral-primary-dark transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto border-e border-default">
      ...
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center px-2 py-1.5 text-white rounded-lg hover:bg-neutral-tertiary hover:text-fg-brand group">
...
<div class="p-4 sm:ml-64 mt-5">
   <div class="p-4 border-1 border-default border-dashed rounded-base   ">
      <div class="grid grid-cols-5 gap-4 mb-4">
         <div class="flex items-center justify-center h-24 rounded-lg bg-neutral-secondary-soft">
      ...
      <div class="flex items-center justify-center h-[500px] rounded-base bg-neutral-secondary-soft mb-4">
         <p class="text-fg-disabled">
               <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7 7V5"/></svg>
         </p>
   </div>   
